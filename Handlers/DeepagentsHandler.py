    ...
    def _build_agent(self):
        ...
        sys_msg = SystemMessage(
            content=(
                ...
                "la mano frente a la cámara: mueve el cursor siguiendo la mano, CERRAR EL PUÑO hace clic "
                "izquierdo, y el gesto de 'PISTOLA' — pulgar + índice extendidos — o de 'DOS DEDOS' — índice + "
                "medio extendidos, señal de victoria — activan modo SCROLL: el cursor se congela y mover la mano "
                "arriba/abajo scrollea la página como la rueda del mouse; se cierra con 'q'/ESC en su ventana de "
                "vista previa). "
                ...
                "Avísale al usuario que para hacer clic tiene que cerrar el puño frente a la cámara, que para "
                "scrollear hace el gesto de pistola (pulgar + índice) o de dos dedos (índice + medio, señal de "
                "victoria) y mueve la mano arriba/abajo, y que puede cerrar el script con 'q' o ESC en la ventana "
                "de vista previa que se abre en esa PC. "
